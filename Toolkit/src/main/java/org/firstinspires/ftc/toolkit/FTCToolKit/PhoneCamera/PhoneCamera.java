package org.firstinspires.ftc.teamcode.FTCToolKit.PhoneCamera;
...
public class PhoneCamera {
    ...
    private LinearOpModeCamera opModeCamera;
    public PhoneCamera(LinearOpMode opMode){
        this.opMode = opMode;
    }
    ...
    public void init(Telemetry telemetry){
        startCamera(telemetry);
    }

    public void startCamera(Telemetry telemetry) {
    ...
    public void stopCameraInSecs(int duration) {
        Thread cameraKillThread = new Thread(new PhoneCamera.CameraKillThread(duration));
    ...
    public void stopCamera() {
        if (camera != null) {
            if (preview != null) {
                ((FtcRobotControllerActivity) opMode.hardwareMap.appContext).removePreviewLinear(opModeCamera);
                preview = null;
            }
            camera.stopPreview();
